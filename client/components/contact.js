  ...
  <div id='contact'>
    ...
    <div className="contact-container">
      <div className="contact">
        <a href="https://drive.google.com/file/d/1-2vq4g749-9C44oQTuVoDZ15JEE7fkSv/view?usp=sharing"> <FontAwesomeIcon icon={faFileAlt} size="3x" className="icon"/></a>
        ...
        <a href="https://www.linkedin.com/in/joe-s-174a1161/"> <FontAwesomeIcon icon={faLinkedin} size="3x" className="icon"/></a>
      </div>
    </div>
  </div>
)
