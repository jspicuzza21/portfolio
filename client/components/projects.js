  ...
  <div id="projects">
    ...
    <div className='pr'>
      <div className='pr-inner'>
        <div className='pr-description'>
          <h3>Bug Out</h3>
          <p>Full stack application that makes practicing coding fun by allowing multiple users to face off in a multiplayer code-off. Each user competes to be the first one to solve coding prompts while earning power ups along the way to slow down the competition. Built as a team.</p>
          <p>Tech Used: Node.js | React | Redux | React-Redux | Webpack | Babel | Postgres | Sequelize | Heroku | Socket.io | ChakraUI</p>
          <div className='pr-icons'>
